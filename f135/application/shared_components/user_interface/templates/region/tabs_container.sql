...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19034346349117700)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19034626697117701)
,p_plug_template_id=>wwv_flow_imp.id(19034346349117700)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19034993888117701)
,p_plug_template_id=>wwv_flow_imp.id(19034346349117700)
,p_name=>'Tabs'
