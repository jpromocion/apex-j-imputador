...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19012062569117690)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19012321010117690)
,p_plug_template_id=>wwv_flow_imp.id(19012062569117690)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19012610863117690)
,p_plug_template_id=>wwv_flow_imp.id(19012062569117690)
,p_name=>'Sub Regions'
