...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18997782973117683)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18998008524117683)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18998350881117683)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18998650046117683)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18998983266117684)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18999248427117684)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18999553643117684)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18999829517117684)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19000147322117684)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19000450833117684)
,p_plug_template_id=>wwv_flow_imp.id(18997782973117683)
,p_name=>'Sub Regions'
