...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19066359361117715)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19066613076117715)
,p_plug_template_id=>wwv_flow_imp.id(19066359361117715)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19066976417117715)
,p_plug_template_id=>wwv_flow_imp.id(19066359361117715)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19067224324117715)
,p_plug_template_id=>wwv_flow_imp.id(19066359361117715)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19067561461117715)
,p_plug_template_id=>wwv_flow_imp.id(19066359361117715)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19067855151117715)
,p_plug_template_id=>wwv_flow_imp.id(19066359361117715)
,p_name=>'Sub Regions'
