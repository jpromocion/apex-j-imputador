...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19058740754117711)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19059031365117712)
,p_plug_template_id=>wwv_flow_imp.id(19058740754117711)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19059348224117712)
,p_plug_template_id=>wwv_flow_imp.id(19058740754117711)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19059684821117712)
,p_plug_template_id=>wwv_flow_imp.id(19058740754117711)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19059928199117712)
,p_plug_template_id=>wwv_flow_imp.id(19058740754117711)
,p_name=>'Sub Regions'
