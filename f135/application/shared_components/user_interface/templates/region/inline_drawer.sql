...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19017404548117692)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19017732106117692)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19018092748117692)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19018304234117692)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19018666397117693)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19018929369117693)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19019287791117693)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19019586559117693)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19019816778117693)
,p_plug_template_id=>wwv_flow_imp.id(19017404548117692)
,p_name=>'Sub Regions'
