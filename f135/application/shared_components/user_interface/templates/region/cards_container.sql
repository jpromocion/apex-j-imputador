...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18995822657117682)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18996111581117682)
,p_plug_template_id=>wwv_flow_imp.id(18995822657117682)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18996437975117682)
,p_plug_template_id=>wwv_flow_imp.id(18995822657117682)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18996714141117683)
,p_plug_template_id=>wwv_flow_imp.id(18995822657117682)
,p_name=>'Sub Regions'
